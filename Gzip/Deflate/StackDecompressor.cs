...
namespace CS_Gzip.Gzip.Deflate
{
     ...
     /// </summary>
     internal class StackDecompressor
     {
//         // constants these are static -> only get calculated once. (represent a 'default'-kind of huffmantree)
//         private static HuffmanStruct FIXED_LENGTH_CODE = makeFixedLenCode();
//         private static HuffmanStruct FIXED_DIST_CODE = makeFixedDistCode();
//
...
//         {
//             var d = new StackDecompressor(input, output);
...
//         /// </summary>
//         private StackDecompressor(BitStream input, Stream output)
//         {
//
//             _input = input;
//             _output = output;
...
//         }
//
//         private void decompressHuffmanBlock(HuffmanStruct lenCode, HuffmanStruct distCode)
//         {
...
//         /// </summary>
//         /// <returns></returns>
//         private (HuffmanStruct lenCode, HuffmanStruct? distCode) readHuffmanCodes()
//         {
...
//             }
//             var codeLenCode = new HuffmanStruct(codeLenCodeLen.ToArray());
//
...
//                     distCodesLen[31] = 1;
//                 }
//                 huffDistCode =new HuffmanStruct(distCodesLen);
//             }
//
...
//         private static HuffmanStruct makeFixedLenCode()
//         {
...
//             return new HuffmanStruct(codeLengths.ToArray());
//         }
//
//         private static HuffmanStruct makeFixedDistCode()
//         {
